...
export const createDefaultResolvers = (
    ...
    component: ({
      ...
      switch (componentItem.system.type) {
          ...
          case contentTypes.article_listing.codename:
            return <ArticleListingComponent item={componentItem as Block_ArticleListing} />
          ...
          case contentTypes.testimonial.codename:
            return <TestimonialComponent item={componentItem as Block_Testimonial} />
          case contentTypes.hubspot_form.codename:
            return <HubSpotFormComponent item={componentItem as Block_HubspotForm} />
          ...
          case contentTypes.youtube_embed.codename:
            return <YouTubeMovieComponent item={componentItem as Block_YouTubeEmbed} />
  ...
  marks: {
    ...
    internalLink: ({
      ...
      return <InternalLink link={link} language={language}>{children}</InternalLink>;
    },
    link: ({ value, children }) => {
