...
export const RichTextContentComponent: FC<Props> = (props) => (
  <div
    className='px-3 md:px-0  lg:w-3/4 mx-auto lg:text-center'
    ...
    component: ({
      ...
      switch (componentItem.system.type) {
        ...
        case contentTypes.hero_unit.codename:
          component = (
            <HeroUnitComponent item={componentItem as Block_HeroUnit} />
          );
          break;
        ...
        case contentTypes.callout.codename:
          component = (
            <CalloutComponent item={componentItem as Component_Callout} />
          );
          break;
        case contentTypes.content_chunk.codename:
          component = (
            <RichTextContentComponent
              item={componentItem as Block_ContentChunk}
            />
          );
          break;
        ...
        case contentTypes.carousel.codename:
          component = (
            <CarouselComponent item={componentItem as Block_Carousel} />
          );
          break;
