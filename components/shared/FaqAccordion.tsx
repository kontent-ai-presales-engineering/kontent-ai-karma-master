    ...
    <div className="rounded-t-lg border border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800"
      ...
      <h2 className="mb-0 mt-0" id="headingOne">
        <button
          ...
          {...createElementSmartLink(contentTypes.faq.elements.question.codename)}>
      ...
      <div
        className={`pt-0 overflow-hidden transition-[max-height] duration-500 ease-in ${active === props.item.system.id ? "max-h-40" : "max-h-0"}`}
