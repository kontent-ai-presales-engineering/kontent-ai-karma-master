...
import { Article, Event, Product, SEOMetadata, WSL_Page, WSL_WebSpotlightRoot } from "../../../models";
  ...
  return (
    <SiteCodenameProvider siteCodename={props.siteCodename}>
      ...
      <div className="min-h-full grow flex flex-col items-center overflow-hidden">
        {props.homeContentItem ? <Menu item={props.item} homeContentItem={props.homeContentItem} /> : <span>Missing top navigation. Please provide a valid navigation item in the web spotlight root.</span>}
...
const PageMetadata: FC<Pick<Props, "siteCodename" | "item" | "defaultMetadata" | "pageType">> = ({ siteCodename, item, defaultMetadata, pageType }) => {
  ...
  const seoDetails = getSeoAndSharingDetails({ page: item, url: "/", includeTitleSuffix: false, siteCodename: siteCodename })
  return (
    <Head>
