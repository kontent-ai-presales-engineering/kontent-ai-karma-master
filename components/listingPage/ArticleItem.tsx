...
export const ArticleItem: FC<Props> = (props) => {
  ...
  return (
    <li
      className='flex-none w-full md:w-1/2 lg:w-1/4 m-0 p-0 relative md:rounded-lg shadow-lg shadow-gray-200 hover:shadow-xl transition-shadow cursor-pointer'
