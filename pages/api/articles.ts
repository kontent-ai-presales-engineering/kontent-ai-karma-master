...
import { getArticlesForListing } from "../../lib/services/kontent-service";
...
const handler: NextApiHandler = async (req, res) => {
    ...
    const articles = await getArticlesForListing(isPreview, language as string, isNaN(pageNumber) ? undefined : pageNumber, articleType);
